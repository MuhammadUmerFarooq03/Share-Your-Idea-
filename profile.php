 	...
 	<div class="profile_left">
      ...
      <?php
        ...
        if($profile_user_obj->isAdmin($userLoggedIn)) {
          ?><p><?php echo '<a href="http://localhost:1234/background_Video_Slider/Demo/admin/users.php" name="remove_friend" class="side-profile-link-color" >Go to Admin</a>' ?></p><?php
        }
