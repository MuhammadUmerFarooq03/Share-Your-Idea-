...
class Post {
	...
	public function submitPost($body, $user_to) {
		...
		if($check_empty != "") {
			...
			//insert post 
			$query = mysqli_query($this->con, "INSERT INTO posts VALUES('', '$body', '$user_to', '$added_by', '$date_added', 'no', 'no', '0')");
			// die();
	...
	public function loadPostsFriends($data, $limit) {
		...
		if(mysqli_num_rows($data_query) > 0) {
			...
			if($count > $limit) 
				...
				$str .= "<input type='hidden' class='noMorePosts' value='true'><p style='text-align: centre;'> No more Ideas to show! </p>";
		}
